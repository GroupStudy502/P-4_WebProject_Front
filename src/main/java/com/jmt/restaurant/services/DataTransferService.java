        ...
        List<Restaurant> items = tmp.stream()
                .map(d -> {
                    ...
                    Restaurant rest = Restaurant.builder()
                        ...
                        .dbsnsStatmBzcndNm(d.get("DBSNS_STATM_BZCND_NM"))
                    ...
                    rest.setOnlineRsrvInfoCn(d.get("ONLINE_RSVD_INFO_CN"));
                    rest.setHmpgUrl(d.get("HMPG_URL"));
                    rest.setKioskYn(d.get("KIOSK_YN").equals("Y"));
                    rest.setMbPmamtYn(d.get("MB_PMAMT_YN").equals("Y"));
                    rest.setSmorderYn(d.get("SMORDER_YN").equals("Y"));
                    rest.setReprsntMenuNm(d.get("REPRSNT_MENU_NM"));
