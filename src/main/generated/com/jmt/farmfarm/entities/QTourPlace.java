...
public class QTourPlace extends EntityPathBase<TourPlace> {
    ...
    public final ListPath<TourPlaceTag, NumberPath<TourPlaceTag>> tags = this.<TourPlaceTag, NumberPath<TourPlaceTag>>createList("tags", TourPlaceTag.class, NumberPath.class, PathInits.DIRECT2);
